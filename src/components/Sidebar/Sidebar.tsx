...
import profil from "../../assets/avatar-01.webp";
...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen">
      {isSidebarOpen && (
        <div className="sidebar bg-gradient-to-b w-64 h-screen flex flex-col justify-between p-4 border-r">
          {/* Header */}
          <div className="flex items-center mb-6 relative">
            ...
            <div className="absolute right-0 hover:cursor-pointer">
              <PanelLeftClose
                ...
                className="w-5 text-gray-600 mr-3"
              />
            </div>
          </div>
          {/* Main Navigation */}
          ...
          <div>
            ...
            <div className="flex items-center p-2 bg-white rounded-lg mt-6">
              <img
                src={profil}
                alt="User Avatar"
      ...
      {!isSidebarOpen && (
        ...
        >
          <PanelRightClose className="w-5 text-gray-600" />
        </button>
      )}
    </div>
  );
